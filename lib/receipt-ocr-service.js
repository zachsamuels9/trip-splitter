...
function detectContextCurrency(value) {
  const text = String(value || "");
  if (/[฿]|(?:\bTHB\b|\bBAHT\b|\bBANGKOK\b|\bPHUKET\b|\bCHIANG\s*MAI\b|\bTHAILAND\b|[\u0E00-\u0E7F]|บาท)/i.test(text)) return "THB";
  if (/[₫]|(?:\bVND\b|\bDONG\b|\bVIETNAM\b|\bVNĐ\b|\bHANOI\b|\bSAIGON\b|\bHO CHI MINH\b|đường|quận|phường|[àáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳýỵỷỹđ])/i.test(text)) return "VND";
